...
const YourComponent = () => {
  const yourWhatsAppNumber = "9944941318"; // Replace with your WhatsApp number
      ...
      <FooterWrapper>
        ...
        <SocialMediaIcons>
          ...
          <CustomTooltip title="GitHub" arrow>
            <SocialMediaIcon href="https://github.com/Poornesh1234567/" target="_blank">
              <GitHubIcon />
            </SocialMediaIcon>
          </CustomTooltip>
        </SocialMediaIcons>
